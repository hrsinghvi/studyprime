...
function PixelTrail({ pixelSize = 20, fadeDuration = 500, delay = 0, pixelClassName }) {
...
const PixelDot = React.memo(function PixelDot({ id, size, fadeDuration, delay, className }) {
